from tkinter import *
ventana = Tk()
ventana.title("CALCULADORA ROGER")
...
boton_igual = Button(ventana,text= "=",width=5,height=2, command= lambda:hacer_opera())
...
boton_paren1.grid(row= 1,column=0 ,padx= 5, pady= 5)
boton_paren2.grid(row=1 ,column=1 ,padx= 5, pady= 5)
